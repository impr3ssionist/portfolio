    ...
    <section id='Contact'>
      ...
      <div className="container contact__container">
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <input type="email" name='email' placeholder='Your return email address' required />
          <textarea name="message" rows='7' placeholder='Your Message to Caleb' required></textarea>
